...
* Please submit your paper through CMT, independent of its length. Please use the IROS paper format for.
...
## Important Dates
* **30 September:** Contributed Paper Submission Deadline via CMT
* **21 October:** Notification of Authors
* **tbd** Final Submissions to the Evaluation Server via  [Codalab](https://competitions.codalab.org/competitions/20940)
* **tbd** Paper Submission via
* **tbd** Winner Announcements and Workshop Invitations
