...
**Workshop Papers**
* Assessing different box merging strategies and uncertainty estimation methods in multimodel object detection - ([ECCV](https://workshopsandtutorials.eccv2020.eu/paper/806/), [YouTube](https://youtu.be/a0_dX_fyvm8)) - **Felippe Schmoeller Roza**, Maximilian Henne, Karsten Roscher and Stephan Günnemann
* Implementing Planning KL-Divergenge - ([ECCV](https://workshopsandtutorials.eccv2020.eu/paper/805/), [YouTube](https://youtu.be/hjJZs63XxpA)) - **Jonah Philion**, Amlan Kar and Sanja Fidler
* ODIN: an Object Detection and Instance Segmentation Diagnosis Framework - ([ECCV](https://workshopsandtutorials.eccv2020.eu/paper/807/), [YouTube](https://youtu.be/lM4EMaZSbVk)) - **Rocio Torres**, Piero Fraternali and Jesus Romero
* Shift Equivariance in Object Detection - ([ECCV](https://workshopsandtutorials.eccv2020.eu/paper/799/), [YouTube](https://youtu.be/bdSuPKmwUlI)) - **Marco Manfredi** and Yu Wang


**Probabilistic Object Detection (PrOD) Challenge Papers**
* 1st: Probabilistic Object Detection with an Ensemble of Experts - ([ECCV](https://workshopsandtutorials.eccv2020.eu/paper/802/), [YouTube](https://youtu.be/zdFhhsjXLxg)) - **Dimity Miller**
* 2nd: EPrOD: Evolved Probabilistic Object Detector with Diverse Samples - ([ECCV](https://workshopsandtutorials.eccv2020.eu/paper/804/), [YouTube](https://youtu.be/QZ1k6DvOM9Y)) - Jaewoong Choi, **Sungwook Lee**, Seunghyun Lee and Byung Cheol Song
* 3rd: Probabilistic Object Detection via Deep Ensembles - ([ECCV](https://workshopsandtutorials.eccv2020.eu/paper/803/), [YouTube](https://youtu.be/qEI4dOYDc18)) - **Zongyao Lyu**, Nolan Guitierrez, Aditya Rajguru and William Beksi
