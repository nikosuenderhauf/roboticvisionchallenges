...
## Overview
This workshop assesses current evaluation procedures for object detection, high-lights their shortcomings and opens discussion for possible improvements.
 ...
 * **11:15 - 11:30** -   Contributed Talk: (PrOD Challenge Winner) - T.B.C.
 * **11:30 - 11:35** -   Closing Remarks
 * **11:35 - 12:10** -   Poster Session_


## Participate in the Competition
To **participate** in the competition, and for more information around the data and submission format, please go to our Codalab Page (TBA).
