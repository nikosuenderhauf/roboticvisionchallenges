...
## News
 * **29 July 2020** Nvidia confirms 1 Titan RTX (worth approx. $5,000) and up to 5 Jetson Nanos (1 per team member) for two winning teams. 
...
The challenge is open until the 1st of September 2020, and a total of **$2,500 USD** will be awarded to high-performing competitors. The two best performing teams also receive a **Titan RTX GPU** (worth approx. $5,000) and up to **5 Jetson Nanos** (1 per team member) provided by our sponsors Nvidia.
